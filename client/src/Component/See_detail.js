...
export default function See_detail(){
    ...
    const PIDobj  = useParams();
    const { b_ID: PID } = PIDobj;
    ...
    const check =() => {
        if (Product.available != false){
            if (sessionStorage.getItem("login_status") == "true"){
                ...
                return(
                    ...
                    <Link to={'/login'}><button className='bt-buy' onClick={null}>สั่งซื้อ <ImCart/></button></Link>
                    </div>
                );
            }
        ...
        <div class="content_detali">
            ...
            <div class="img_detali">
                 <img src={"https://drive.google.com/uc?export=view&id="+Product.PID} alt=""></img>
            </div>
